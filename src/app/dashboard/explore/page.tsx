...
// ─────────────────────────────────────────────────────────────
// Category Filter — raised chips, pressed when active
// ─────────────────────────────────────────────────────────────
    ...
    {categories.map(cat => (
      <button
        ...
        style={{
          ...
          background: selected === cat ? 'linear-gradient(135deg, #6C63FF, #8B5CF6)' : NEU.BG,
          color: selected === cat ? '#fff' : '#334155',
          boxShadow: selected === cat ? NEU.pressed : NEU.raised,
...
// ─────────────────────────────────────────────────────────────
// Activity Card — raised, floats on hover
// ─────────────────────────────────────────────────────────────
const ActivityCard = ({ activity }: { activity: typeof ACTIVITIES_MOCK[0] }) => (
  ...
  >
    ...
    <div style={{ padding: '6px 18px 18px', flex: 1, display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      {/* Footer */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto', paddingTop: 12, borderTop: '1px solid rgba(163,177,198,.2)' }}>
...
export default function ExploreActivitiesPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 36, maxWidth: 1200, margin: '0 auto', paddingBottom: 48 }}>
      ...
      {/* Search & Filter Bar */}
      <div style={{ background: NEU.BG, borderRadius: 24, boxShadow: NEU.raised, padding: '1.5rem 2rem', border: 'none', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
        ...
        <div style={{ position: 'relative', width: '100%', maxWidth: 320 }}>
          ...
          <input
            ...
            style={{
              ...
              background: NEU.BG, borderRadius: 14, border: 'none', outline: 'none',
      ...
      {filtered.length > 0 ? (
        ...
        <div style={{
          background: NEU.BG, borderRadius: 28, boxShadow: NEU.raised, padding: '3rem 2rem',
          textAlign: 'center', border: 'none',
        }}>
          <div style={{ width: 64, height: 64, borderRadius: 24, background: NEU.BG, boxShadow: NEU.pressed, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
      ...
      {/* CTA Banner */}
      <div style={{ background: NEU.BG, borderRadius: 28, boxShadow: NEU.raised, padding: '2rem 2.5rem', textAlign: 'center', border: 'none' }}>
        <div style={{ width: 52, height: 52, borderRadius: 18, background: NEU.BG, boxShadow: NEU.pressed, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
        ...
        <button className="neu-btn-primary" style={{ padding: '12px 28px' }}>
