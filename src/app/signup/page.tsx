...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccess(true)
      setLoading(false)
      // Optional: automatically redirect to login or dashboard
        ...
        <form onSubmit={handleSignup}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium leading-none text-zinc-100" htmlFor="name">
                Name
              </label>
              <Input
                id="name"
          ...
          <CardFooter className="flex flex-col space-y-4 bg-transparent border-t-white/20 pt-6">
            <Button className="w-full bg-white text-zinc-900 hover:bg-zinc-200" type="submit" disabled={loading || success}>
            ...
            <div className="w-full">
              <Button variant="outline" type="button" className="w-full bg-white/10 border-white/20 hover:bg-white/20 text-white hover:text-white" onClick={() => handleOAuth('google')} disabled={loading || success}>
            ...
            <div className="text-center text-sm text-zinc-200 mt-2">
              ...
              <Link className="font-semibold text-white hover:underline drop-shadow-sm" href="/login">
                Sign in
              </Link>
            </div>
          </CardFooter>
